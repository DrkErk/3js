...
gui.add(uniforms.uSliceStart, 'value', - Math.PI, Math.PI, 0.0001).name('uSliceStart')
gui.add(uniforms.uSliceArc, 'value', 0, Math.PI * 2, 0.0001).name('uSliceArc')

//needed to get the sliced material to work.
const patchMap = {
    csm_Slice:
    {
...
const sliceDepthMaterial = new CustomShaderMaterial({
            ...
            if(child.name == 'outerHull')
                {
                    ...
                    child.customDepthMaterial = sliceDepthMaterial
                }
                else
                {
