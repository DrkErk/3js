 ...
 * 
 * const is static, let is variable
 * 
 * smooth blender objs to make sure that the exported geometery will be indexed
 * 
 */
...
//
// // Mesh
// let wobble = new THREE.Mesh(geometry, material)
