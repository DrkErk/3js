import {
  ...
  ToneMappingEffect,
  VignetteEffect
} from "./chunk-VBAAIJ5W.js";
import {
  require_jsx_runtime
} from "./chunk-R5IYAWQI.js";
import {
  isWebGL2Available
} from "./chunk-C56F6YQQ.js";
import {
  applyProps,
  createPortal,
  extend,
...
var DepthOfField = (0, import_react.forwardRef)(function DepthOfField2({
  blendFunction,
  worldFocusDistance,
  worldFocusRange,
  focusDistance,
  ...
  return (0, import_jsx_runtime.jsx)("primitive", { ...props, ref, object: effect, target });
});
...
var LensFlare = (0, import_react.forwardRef)(
  ({ position = new Vector3(-25, 6, -60), followMouse = false, smoothTime = 0.07, ...props }, ref) => {
    ...
    const [mouse2d] = (0, import_react.useState)(() => new Vector2());
    const effect = (0, import_react.useMemo)(() => new LensFlareEffect(props), [props]);
    useFrame((_, delta) => {
      var _a, _b, _c;
