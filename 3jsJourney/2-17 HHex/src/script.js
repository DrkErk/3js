...
const tick = () =>
{
    ...
    ghost2.position.y = Math.sin(elapsedTime * 3) + Math.tan(elapsedTime * 2.5)

    const ghost3Angle = -elapsedTime * .18
    ghost3.position.x = Math.cos(ghost2Angle) * (7 + Math.sin(elapsedTime * .32))
    ghost3.position.z = Math.sin(ghost2Angle) * (7 + Math.sin(elapsedTime * .5))
