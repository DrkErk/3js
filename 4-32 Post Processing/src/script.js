...
const futurePass = new ShaderPass(FutureShader)
futurePass.material.uniforms.uNormalMap.value = textureLoader.load(
    '/textures/interfaceNormalMap.png')
futurePass.enabled = true
effectComposer.addPass(futurePass)
